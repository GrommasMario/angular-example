...
@NgModule({
    declarations: [MeetingCardListComponent, MeetingCardComponent],
    exports: [MeetingCardListComponent, MeetingCardComponent],
    imports: [CommonModule, InviteCardModule, GridListModule],
})
