...
import { IMeetingsHttpService } from './meetings.http-service';

export class MeetingsHttpMock implements IMeetingsHttpService {
    private list = [
        {
            id: 1,
    ...
    getList() {
        return new Observable<IMeetingHttpIn[]>((subscriber) => {
